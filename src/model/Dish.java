...
public class Dish implements Serializable {
    ...
    /**
     * метод позволяет задать цену блюда цена долждна быть неотрицательно если
     * цена меньше нуля, то цена останется прежней
     *
     * @param price новая цена - вещественное число типа double
     */
