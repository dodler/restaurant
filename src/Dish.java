...
public class Dish {
    ...
    private MyController.DishCategory category; // категория блюда
     ...
     * @param category - категория (горячее, суши и т.д.)
     */
    public Dish(final int id,
            final String name,
            final MyController.DishCategory category
    ) {
        this.id = id;
        this.name = name;
    ...
    /**
     * возвращает категорию блюда
     *
     * @return
     */
    public MyController.DishCategory getCategory() {
